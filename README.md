...
[`docs/architecture/`](docs/architecture/README.md). Архивные материалы в
`Kira.md`, `content-kira-sekira.txt`, `Chat/` и `old-static-site/` не являются
источником текущих цен и требований.
