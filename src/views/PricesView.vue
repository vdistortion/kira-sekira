  ...
  <the-page title="Стоимость съёмок">
    <div class="prices-page">
        ...
        <div class="prices-page__text">
          <ul>
            ...
            <li>
              ...
              (все фото отдаются в цвете + бонус: ч/б версия)
            </li>
            <li>Обработка материала 1-2 недели</li>
          </ul>
          <div>
            *Когда мы приходим в студию, мы предполагаем, что будем сниматься от и до указанного
            часа. Это не так, у какого фотографа вы бы ни снимались. Зал студии всегда освобождается
            за 5 минут до окончания бронирования, общие 10 минут занимают переодевания между сценами,
            <br>
            3-5 минут - настройка/смена световых схем, а ваше привыкание к камере, из опыта,
            происходит и вовсе после 15 мин съёмки. Поэтому этот вариант съёмки я называю - экспресс.
          </div>
          <div>
            Экспресс подходит тем, кто:
            <ul>
              <li>снимается не впервые;</li>
              <li>быстро раскрепощается перед камерой;</li>
              <li>хочет решить одну-две задачи за съёмку;</li>
            </ul>
            Более комфортным и рекомендуемым является пакет ADVANCED.
          </div>
          <div>
            <strong>ДОПОЛНИТЕЛЬНЫЕ УСЛУГИ:</strong>
            <br>
            Дополнительная ретушь - 1 фото/200р.
            <br>
      ...
      <div class="prices-page__item">
        ...
        <div class="prices-page__text">
          <ul>
            <li>2 часовая съёмка</li>
            <li>4 образа комфортно снять за это время</li>
            <li>все получившиеся кадры (60+) в цветокоррекции</li>
            <li>
              детальная ретушь и художественная обработка с применением эффектов фотошопа 25 фото
              (все фото отдаются в цвете + бонус: ч/б версия)
            </li>
            <li>Обработка материала 1-2 недели</li>
          </ul>
          ...
          <div>
            <strong>ВАЖНО:</strong>
            <br>
            Оплата производится в день съёмки. Бронирование студии осуществляется только мной.
          </div>
        </div>
      </div>
    </div>
